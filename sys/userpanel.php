    ...
    <?php //require('views/partials/section1.php') ?>
        <table class="mx-auto w-full">
            ...
            <tbody>
                <?php
                //$loginUerId = $_SESSION['loginUser']['userId'];
                ...
                //    print_r($_SESSION['loginUser']);
                    ...
                    <?php if($loginemail == $dbemail ): ?>
                        ...
                        <a href="./delete_user.php?userId=<?php echo $row['userId'];?>"><svg class="w-8 h-8" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M0 0h24v24H0z" fill="none"></path><path d="M0 0h24v24H0V0z" fill="none"></path><path d="M6 19c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V7H6v12zm2.46-7.12l1.41-1.41L12 12.59l2.12-2.12 1.41 1.41L13.41 14l2.12 2.12-1.41 1.41L12 15.41l-2.12 2.12-1.41-1.41L10.59 14l-2.13-2.12zM15.5 4l-1-1h-5l-1 1H5v2h14V4z"></path></svg></a>
                
                    <?php else: ?>    
                        <a href="unauthuser.php"><svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"><path d="M4 8V6a6 6 0 1 1 12 0v2h1a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2v-8c0-1.1.9-2 2-2h1zm5 6.73V17h2v-2.27a2 2 0 1 0-2 0zM7 6v2h6V6a3 3 0 0 0-6 0z"></path></svg></a>
                    <?php endif; ?>
                    </td>
                 </tr>
                 <?php   endforeach ?>
