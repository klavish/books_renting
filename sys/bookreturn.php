        ...
        <div class="flex flex-1 m-auto w-full">
            <form class="bg-slate-100 flex flex-col justify-center space-y-2 px-4 py-6 " name="bookreturn" enctype="multipart/form-data" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                ...
                <div class="grid grid-cols-2 gap-4">
                        ...
                        <input type="hidden" name="bookId" class="border rounded-md w-full px-4 py-2 text-sm" value="<?php  $_row['bookId'] ?? ''; ?>">
                        <input type="hidden" name="categoryId" class="border rounded-md w-full px-4 py-2 text-sm" value="<?php  $_row['categoryId'] ?? ''; ?>">
                        <input type="hidden" name="rentDate" class="border rounded-md w-full px-4 py-2 text-sm"  value="<?php  $_row['rentDate'] ?? ''; ?>">
                        <input type="hidden" name="dueDate" class="border rounded-md w-full px-4 py-2 text-sm"  value="<?php  $_row['dueDate'] ?? ''; ?>">   
                ...
                <a href="./payment.php" class=" text-white rounded-md bg-blue-700 w-full px-28 py-2 text-center">Pay</a>
            </form>
