        ...
        <ul class="flex  w-full  gap-6  items-center justify-evenly">
            ...
            <li>
                <a class="pt-4 cursor-pointer">
                    <img class="rounded-md w-24" src="https://media.istockphoto.com/id/1140385944/photo/books-of-advertising-and-branding-in-front-grey-wall.webp?b=1&s=170667a&w=0&k=20&c=1Jj1WqbRYyXXEOye6s5c5GNI3oxx7kkEzeAKfOUEGyY=" alt="boo" title="Boogen">
                </a>
            </li>

            <!--anchors  -->
            <li class="flex gap-3">
                <a href="./homepge.php" class="hover:underline underline-offset-2  hover:text-blue-800  text-white" aria-label="user registration">Home</a>

                <a href="./bookspage.php" class="hover:underline underline-offset-2 hover:text-blue-800 text-white" aria-label="user registration">Books</a>

                <a href="./bookreturn.php" class="hover:underline underline-offset-2 hover:text-blue-800 text-white" aria-label="user registration">Return</a>
            </li>
            ...
            <li class="relative">
                    <select name="category" id="category"
                        class="bg-gray-50 border border-gray-300  text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block  px-4 py-2 ">
            ...
            <li class="flex gap-0 items-center pl-3">
